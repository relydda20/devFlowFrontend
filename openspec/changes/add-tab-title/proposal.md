...
## What
Add descriptive browser tab titles (document.title) for every top-level page in the SPA. Titles should follow the pattern `<Page title> — DevFlow` with a sensible default.
...
- Provide a default suffix ` — DevFlow` and a default title for unknown routes.
